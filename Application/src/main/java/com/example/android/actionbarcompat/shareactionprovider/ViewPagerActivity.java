...
public class ViewPagerActivity extends ActionBarActivity {
    ...
    static ArrayList<ContentItem> getSampleContent() {
        ...
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_1.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_2.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_3.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_TEXT, R.string.quote_2));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_4.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_5.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_6.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_TEXT, R.string.quote_3));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_7.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_8.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_9.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_TEXT, R.string.quote_4));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_10.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_11.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_12.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_13.jpg"));
        items.add(new ContentItem(ContentItem.CONTENT_TYPE_IMAGE, "neo_14.jpg"));
